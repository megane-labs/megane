...
/** Baseline platform directory: `tests/e2e/baselines/<PLATFORM>/`. */
export const RENDER_PLATFORM = "bench-render";

/**
 * Pixel budget for "this pipeline draws the reference picture".
 *
 * Deliberately tighter than the E2E default: the two images come from the same
 * fixture, camera and host, so anything beyond antialiasing noise means the
 * pipeline genuinely drew something else.
 */
export const RENDER_MAX_DIFF_PERCENT = 0.5;
